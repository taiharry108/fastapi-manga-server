...
Revision ID: fc73d514eb96
Revises: 
Create Date: 2020-09-21 17:13:03.154080
...
def upgrade():
    ...
    op.create_index(op.f('ix_manga_sites_url'), 'manga_sites', ['url'], unique=True)
    ...
    op.create_index(op.f('ix_mangas_url'), 'mangas', ['url'], unique=True)
    ...
    op.create_index(op.f('ix_chapters_page_url'), 'chapters', ['page_url'], unique=True)
